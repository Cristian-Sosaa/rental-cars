          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Toyota RAV4 Hybrid" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="219 HP" type="number" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="suv">Camioneta SUV</SelectItem>
                    <SelectItem value="pickup">Pickup</SelectItem>
                    <SelectItem value="familiar">Familiar / Van</SelectItem>
                    <SelectItem value="lujo">Alta gama / Lujo</SelectItem>
